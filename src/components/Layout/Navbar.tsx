...
import { Search, Bell, User, Settings, LogOut, Sun, Moon, PenTool, Home, Coins, DollarSign, Globe, Menu, X, MessageCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">Synctale</span>
          </Link>
            ...
            {user ? (
              <>
                ...
                <div className="relative hidden md:block">
                  ...
                  >
                    <img
                      src={user.profilePicture || 'https://images.pexels.com/photos/91227/pexels-photo-91227.jpeg?auto=compress&cs=tinysrgb&w=50'}
                      alt={user.username}
                  ...
                  {showProfileMenu && (
                    <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2">
                      <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">{user.balance} coins</p>
                      </div>
                ...
                <div className="relative hidden md:block">
                  ...
                  {showLanguageMenu && (
                    <div className="absolute right-0 mt-2 w-32 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1">
                      <button onClick={() => { setLanguage('en'); setShowLanguageMenu(false); }} className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-100 dark:hover:bg-gray-700 ${language === 'en' ? 'text-green-600 font-medium' : 'text-gray-700 dark:text-gray-300'}`}>
                        English
                      </button>
                      <button onClick={() => { setLanguage('fr'); setShowLanguageMenu(false); }} className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-100 dark:hover:bg-gray-700 ${language === 'fr' ? 'text-green-600 font-medium' : 'text-gray-700 dark:text-gray-300'}`}>
                        Français
                      </button>
                    </div>
                  )}
